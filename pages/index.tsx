      ...
      <Layout>
        ...
        <section className="relative py-24 sm:py-32 flex flex-col items-center justify-center text-center space-y-10">
          <div className="flex flex-col sm:flex-row sm:flex-wrap items-center justify-center gap-3">
            ...
            <Link
              href="#cpu-profiles"
              className="group inline-flex items-center rounded-full border border-amber-500/30 bg-amber-500/10 px-3 py-1 text-sm font-medium text-amber-700 dark:text-amber-300 hover:bg-amber-500/20 transition-colors"
            >
              <Cpu className="mr-2 h-4 w-4 text-amber-500" />
              <span>Node CPU profiles</span>
              <ArrowRight className="ml-1.5 h-3.5 w-3.5 transition-transform group-hover:translate-x-0.5" />
            </Link>
          </div>
            ...
            <Card className="bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/50 transition-colors shadow-sm">
              <CardHeader>
                <div className="h-12 w-12 rounded-lg bg-amber-500/10 flex items-center justify-center mb-4">
                  <Cpu className="h-6 w-6 text-amber-600 dark:text-amber-500" />
                </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-12 items-center">
              <div className="space-y-6">
                <div className="inline-flex items-center rounded-full border border-amber-500/30 bg-amber-500/10 px-3 py-1 text-sm font-medium">
                  <Cpu className="mr-2 h-4 w-4 text-amber-500" />
                  <span className="text-amber-700 dark:text-amber-300">Node CPU profiling</span>
                </div>
                ...
                <div className="grid gap-3 text-sm">
                  ...
                  <div className="rounded-xl border border-border/60 bg-card/50 p-4">
                    ...
                    <p className="mt-1 text-muted-foreground">Large profile payloads live as separate CPU profile documents while result cards keep lightweight references.</p>
                  </div>
                  <div className="rounded-xl border border-border/60 bg-card/50 p-4">
                    <div className="font-semibold">Use a profile with real work</div>
                    <p className="mt-1 text-muted-foreground">The synthetic commerce example gives the profiler a richer workload than the older slim sample profile.</p>
                  </div>
                </div>
              ...
              <Link href={SYNTHETIC_COMMERCE_EXAMPLE_PATH} className="group block relative focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/60 rounded-2xl">
                <div className="absolute -inset-4 bg-gradient-to-tr from-amber-500/20 via-orange-500/10 to-violet-500/20 rounded-2xl blur-2xl transition-opacity group-hover:opacity-80" aria-hidden="true" />
                <div className="relative overflow-hidden rounded-xl border border-border/60 bg-slate-950 shadow-xl transition-transform group-hover:-translate-y-0.5 group-hover:shadow-2xl">
                  ...
                  <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-950 via-slate-950/80 to-transparent p-5">
                    <div className="inline-flex items-center rounded-full border border-amber-400/40 bg-amber-500/15 px-3 py-1 text-xs font-semibold text-amber-100 shadow-sm">
                      <Cpu className="mr-1.5 h-3.5 w-3.5 text-amber-300" />

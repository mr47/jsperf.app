...
import { runQuickJSAnalysis } from '../../../../lib/engines/runner'
import {
  assertSessionActive,
  handleApiError,
  loadAnalysisSession,
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const profiles = await runQuickJSAnalysis(session.prepared.runtime.tests, {
    ...
    await storeSessionResult(session, 'quickjs', profiles)

 ...
 *
 * jsperf.app's /api/benchmark/analyze enqueues jobs concurrently with the
...
const DEFAULT_PROFILES = [
  { label: '0.5x', resourceLevel: 1, cpus: 0.5, memMb: 256 },
  { label: '1x', resourceLevel: 1, cpus: 1.0, memMb: 512 },
  { label: '2x', resourceLevel: 1, cpus: 2.0, memMb: 1024 },
]

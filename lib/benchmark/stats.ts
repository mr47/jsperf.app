import type { BenchmarkSample, BenchmarkStatsOptions } from './types'
...
export function computeBenchmarkStats(
  ...
  { iterations = 0, totalMs = 0, sliceMs = 200 }: BenchmarkStatsOptions = {},
) {
...
export function benchmarkStatsSource(): string {
  return `
